...
public:
    ...
    void setupUi(QMainWindow *ColorBlindAppClass)
    {
        ...
        spinThreads->setGeometry(QRect(370, 270, 81, 27));
    ...
    void retranslateUi(QMainWindow *ColorBlindAppClass)
    {
        ...
        viewOriginal->setText(QCoreApplication::translate("ColorBlindAppClass", "Obraz1", nullptr));
        viewProcessed->setText(QCoreApplication::translate("ColorBlindAppClass", "Obraz2", nullptr));
